...
import org.jetbrains.kotlin.ir.declarations.findAnnotationsByFqName
    ...
    override fun visitCall(expression: IrCall): IrExpression {
        ...
        descriptor.getExternalObjCMethodInfo()?.let { methodInfo ->
            val isInteropStubsFile =
                    currentFile.findAnnotationsByFqName(FqName("kotlinx.cinterop.InteropStubs")).isNotEmpty()
        ...
        return when (descriptor) {
            context.interopBuiltIns.typeOf -> {
                ...
                if (classDescriptor == null) {
                    ...
                    builder.irGetObject(symbolTable.referenceClass(companionObjectDescriptor))
                }
            }
            else -> expression
        }
